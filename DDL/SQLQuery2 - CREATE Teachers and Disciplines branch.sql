--SQLQuery2 - CREATE Teachers and Disciplines branch.sql
...
(
	...
	CONSTRAINT FK_TDR_Discpline		FOREIGN KEY(discipline)		REFERENCES	Disciplines(discipline_id)
);
...
(
	...
	CONSTRAINT FK_DD_Disciplie	FOREIGN KEY(discipline)				REFERENCES	Disciplines(discipline_id),
